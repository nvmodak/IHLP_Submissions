...
public class Client_2 {
 ...
 public Client_2(String address, int port) throws InterruptedException
 {
     ...
     // keep reading until "Over" is input
    	 ...
    	 int totalCards_Available = 13;
			for(int iFetchCards = 1; iFetchCards <= 13; iFetchCards++, totalCards_Available -- ) {
			    ...
			    System.out.println("selected Card is " + cardSelected +" of Diamonds");
...
public static void main(String args[]) throws InterruptedException
 {
     Client_2 client = new Client_2("127.0.0.1", 5002);
 }
}